...
public class StoreListAdapter extends RecyclerView.Adapter<StoreListAdapter.ViewHolder> {
    ...
    Context mContext;
    ArrayList<Or2goVendorInfo> mStoreList;
    ArrayList<Or2goOrderInfo> orderList;
    Integer kkml = 0;
    String cPosition;
    public StoreListAdapter(Context mContext, ArrayList<Or2goVendorInfo> mStoreList, ArrayList<Or2goOrderInfo> orderList, String position) {
    ...
    public void onBindViewHolder(@NonNull StoreListAdapter.ViewHolder holder, int position) {
        Or2goVendorInfo or2goVendorInfo = mStoreList.get(position);
        holder.textViewName.setText(or2goVendorInfo.vId);
        holder.textViewAddress.setText(or2goVendorInfo.vAddress);
        holder.textViewStatus.setText(or2goVendorInfo.vStatus);
        //
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageViewStatus = itemView.findViewById(R.id.imageActiveStatus);
        }
    }
}
