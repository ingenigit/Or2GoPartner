        ...
        if (result > 0)
        {
            ...
            try {
                ...
                if (result.equals("ok")) {
                    ...
                    System.out.println("Status Update Callback :  OrderId : " + mOrderId + "  status1=" + mStatus);
                    System.out.println("Status Update Callback Response:  OrderId : " + resordid + "  status1=" + resordsts);
