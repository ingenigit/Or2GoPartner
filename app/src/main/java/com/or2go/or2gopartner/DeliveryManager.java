...
import com.or2go.or2gopartner.server.ActiveDAListCallback;
import com.or2go.or2gopartner.server.AssignDACallback;
...
public class DeliveryManager {
    ...
    public void assignDA(Or2GoDAInfo daInfo, Or2goOrderInfo ordinfo)
    {
        ...
        AssignDACallback assigndacb = new AssignDACallback(mContext, ordinfo.getId(), daInfo.daId);
        //ordercb.setViewAdapter(itemlist, itemlistadapter);
        ...
        try
        {
            ...
            pktHeader.accumulate("ordStoreId", gAppEnv.gAppSettings.getStoreId());
