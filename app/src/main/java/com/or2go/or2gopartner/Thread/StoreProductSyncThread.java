            ...
            public void handleMessage(Message msg) {
                ...
                switch(nMsg)
                {
                    case OR2GO_STORE_DATA_PRODUCT /*OR2GO_PRODUCT_LIST*/:
                        ...
                        gAppEnv.getGposLogger().d("ProductSyncThread : updating product");
                        ...
                        try {
                            ...
                            gAppEnv.getStoreManager().postDBSyncMessage(OR2GO_VENDOR_PRODUCT_DBSYNC);
                    ...
                    case OR2GO_STORE_DATA_PRICE/*OR2GO_PRICE_LIST*/:
                        ...
                        try {
                            ...
                            gAppEnv.getStoreManager().postDBSyncMessage(OR2GO_VENDOR_PRICE_DBSYNC);
                    ...
                    case OR2GO_STORE_DATA_SKU:
                        ...
                        try {
                            ...
                            storeInfo.getPriceDBState().doneDBUpdate();
                            gAppEnv.getStoreManager().postDBSyncMessage(OR2GO_VENDOR_SKU_DBSYNC);
