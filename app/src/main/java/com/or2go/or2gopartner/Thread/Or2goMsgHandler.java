...
import com.or2go.or2gopartner.MainActivity;
import com.or2go.or2gopartner.OrderDetailsActivity;
...
public class Or2goMsgHandler extends Thread{
    ...
    private UnitManager mUnitMgr = new UnitManager();

    public Or2goMsgHandler(Context context)
    {
        mContext =context;
...
//                        gAppEnv.getOrderManager().updateDeliveryStatus(ordid, ORDER_STATUS_COMPLETE);
                    ...
                    else if (pkttype==OR2GO_MSG_DA_ORDER_ASSIGN_ACCEPT)
                    {
                        ...
                        gAppEnv.getOrderManager().updateDeliveryStatus(ordid, OR2GO_DELIVERY_STATUS_ASSIGN_ACCEPT);
                    ...
                    else if (pkttype==OR2GO_MSG_DA_ORDER_ASSIGN_REJECT)
                    {
                        ...
                        String ordid = pktHeader.getString("ordId");
                        gAppEnv.getOrderManager().updateDeliveryStatus(ordid, OR2GO_DELIVERY_STATUS_ASSIGN_REJECT);
                    }
    ...
    private void processOnlineOrder(JSONObject jsonPkt)
    {
        ...
        try {
            ...
            {
                ProductManager prmgr = gAppEnv.getStoreManager().getProductManager();
                ...
                //acptcharge = pktHeader.getString("ordAgreeDeliveryCharge");
                ...
                if (res) {
                    ...
                    gAppEnv.getNotificationManager().setNotification("Order Assign", notmsg, orderIntent);
                }
            }
	 		   /*
